...
enfocado en sistemas POS, SaaS multi-tenant y plataformas para producción.

- 🎓 &nbsp;Estudiando **Ingeniería de Sistemas** en la Universidad de la Costa
- 💼 &nbsp;Fundador de **Baussa** — software a medida para negocios nacionales e internacionales
- 🔧 &nbsp;Director de **Junior Technical Service**, taller de electrónica
- 🚀 &nbsp;Actualmente construyendo **ClipManager**, SaaS para barberías y peluquerías
...
<sub>
  ...
  <code>https://stevenbaussa.ct.ws/</code> &nbsp;·&nbsp;
